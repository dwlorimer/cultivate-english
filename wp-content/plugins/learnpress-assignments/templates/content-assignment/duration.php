    ...
    <div class="progress-items">
        <div class="progress-item assignment-countdown">
            ...
            <span class="progress-label">
				<?php echo $duration->get() ? __( 'Time remaining', 'learnpress-assignment' ) : ( absint($duration_time) ? __('Time Up!', 'learnpress-assignments') : __( 'Unlimited Time', 'learnpress-assignment' ) ); ?>
            </span>
        </div>
    </div>
</div>