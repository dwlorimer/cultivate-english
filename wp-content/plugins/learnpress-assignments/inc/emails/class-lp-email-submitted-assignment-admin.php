...
if ( ! class_exists( 'LP_Email_Assignment_Submitted_Admin' ) ) {
	 ...
	 * Class LP_Email_Assignment_Submitted_Admin.
	 */
	class LP_Email_Assignment_Submitted_Admin extends LP_Email {
		...
		public function __construct() {
			...
			$this->description = __( 'Send this email to admin when user have submitted assignment.', 'learnpress-assignment' );

			$this->template_base  = LP_ADDON_ASSIGNMENTS_TEMPLATE;
			$this->template_html  = 'emails/submitted-assignment-admin.php';
