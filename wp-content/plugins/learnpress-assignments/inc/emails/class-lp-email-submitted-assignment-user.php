...
if ( ! class_exists( 'LP_Email_Assignment_Submitted_User' ) ) {
	...
	class LP_Email_Assignment_Submitted_User extends LP_Email {
		...
		public function __construct() {
			...
			$this->description = __( 'Send this email to user when they have submitted assignment.', 'learnpress-assignment' );

			$this->template_base  = LP_ADDON_ASSIGNMENTS_TEMPLATE;
			$this->template_html  = 'emails/submitted-assignment-user.php';
