...
if ( ! class_exists( 'LP_Email_Assignment_Evaluated_User' ) ) {
	 ...
	 * Class LP_Email_Assignment_Evaluated_User.
	 */
	class LP_Email_Assignment_Evaluated_User extends LP_Email {
		...
		public function __construct() {
			...
			$this->description = __( 'Send this email to user when teacher have evaluated assignment.', 'learnpress-assignment' );
