 ...
 * @return string
 */
function education_pack_template_path() {
	return education_pack_Wrapper::$main_template;
}
 ...
 * @return string
 */
function education_pack_template_base() {
	return education_pack_Wrapper::$base;
}

/**
 * Theme wrapper class
 */
class education_pack_Wrapper {
...
add_filter( 'template_include', array( 'education_pack_Wrapper', 'wrap' ), 99 );
