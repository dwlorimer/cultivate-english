...
if ( ! class_exists( 'Thim_Plugin' ) ) {
	class Thim_Plugin {
		...
		public function __construct( $slug = '', $is_wporg = false ) {
			...
			$this->messages = array( esc_attr__('Something went wrong!', 'education-pack' ) );
		...
		public function get_text_status() {
			$arrText = array(
				'active'        => esc_attr__('Active', 'education-pack' ),
				'inactive'      => esc_attr__('Inactive', 'education-pack' ),
				'not_installed' => esc_attr__('Not Installed', 'education-pack' )
			);
